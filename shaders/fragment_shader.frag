#version 430 core
   ...
   void main()
   {
      float gridSizeF = float(uGridSize);
      ...
      vec3 uColorBottom = vec3(0.0, 0.8, 1.0);
      vec3 uColorMiddle = vec3(1.0, 0.2, 0.7);
      vec3 uColorTop = vec3(1.0, 0.8, 0.1);
      
      vec3 baseColor = (yNorm < 0.5) ? mix(uColorBottom, uColorMiddle, yNorm * 2.0) : mix(uColorMiddle, uColorTop, (yNorm - 0.5) * 2.0);
